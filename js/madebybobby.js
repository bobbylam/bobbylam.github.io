...
//Google Maps (Skinned)
var myCoords = new google.maps.LatLng(47.614848,-122.3358423);
var myOptions = {
    zoom: 11,
    center: myCoords,
    mapTypeId: google.maps.MapTypeId.ROADMAP,
    disableDefaultUI: true,
    // Thanks to snazzymaps.com for the map style below!
...
var marker = new google.maps.Marker({
    position: myCoords,
    map: map,
    title: "Now when I say 2-0, you say...nah, you know the rest!"
});